...
"""Plot the total value over time if invested and not invested"""
plt.figure(figsize=(36, 18))
plt.plot(total_value_cheap_each_month, label='Total Value Cheap')
plt.plot(total_value_expensive_each_month, label='Total Value Expensive')
plt.plot(total_value_cheap_each_month_if_invested, label='Total Value Cheap If Invested')
plt.plot(total_value_expensive_each_month_if_invested, label='Total Value Expensive If Invested')
plt.xlabel('Months')
plt.ylabel('Total Value')
plt.title('Total Value Over Time')
plt.legend()
